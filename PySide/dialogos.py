...
class VentanaPrincipal(QMainWindow):
    ...
    def click_boton(self,estado):
        ...
        # #se bloquea la ventana padre o modal
        # #solo podemos interactuar con la nueva ventana
        # #para ejecutar la vetana modal tenemos que mandar a llamar el metodo exec
        #dialogo.exec()
        #ejecutamos usando la clase
        dialogo= VentanaDialogo(self)
        valor_regresado=dialogo.exec_()
        print(f'Valor regresado: {valor_regresado}')
        if valor_regresado:
